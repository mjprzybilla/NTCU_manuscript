...
### Display SigFit Results
```{r}
#SigFit_reconstruction_file <- paste0(SigFit.dir, substr(sample_name, 1,7), "_SigFit_reconstruction.pdf")

#<object data=`r SigFit_reconstruction_file` width="1200px" height="1200px">
#    <embed src=`r SigFit_reconstruction_file`>
#    </embed>
#</object>
```
