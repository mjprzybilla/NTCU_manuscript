...
if (length(args)>=3) {
  patientID = args[1] # patientID = "MD6812_Left_lobe"
  ndp_input_dir = args[2] # ndp_input_dir = "/lustre/scratch126/casm/team154pc/mp34/lung/NTCU/WGS/NDP/MD6812_Left_lobe/ndp_2023_06_09_MD6812_qmdvc"
  # ndp_input_dir = "/Users/mp34/sanger/team154pc/mp34/lung/NTCU/WGS/NDP/MD6812_Left_lobe/ndp_2023_06_09_MD6812_qmdvc"
  script.dir = args[3] # script.dir = "/lustre/scratch117/casm/team154/mp34/src/breast-ndp-tree-building/"
...
if (length(args) >= 4) {
  tree_out_dir = args[4] # tree_out_dir = "/lustre/scratch126/casm/team154pc/mp34/lung/NTCU/WGS/NDP/MD6812_Left_lobe/phylogenies/"
  # tree_out_dir = "/Users/mp34/sanger/team154pc/mp34/lung/NTCU/WGS/NDP/MD6812_Left_lobe/phylogenies/"
} else { 
...
# repo_location <- "/Users/mp34/sanger/team154pc/mp34/src/snv-clustering-using-the-dirichlet-process/"
repo_location <- "/lustre/scratch117/casm/team154/mp34/src/snv-clustering-using-the-dirichlet-process/"
...
# remove the clusters which appear to be artefactual
x.cluster_and_samples <- x.cluster_and_samples[-c(4, 8, 15, 20, 25),] # MD6812
# x.cluster_and_samples <- x.cluster_and_samples[-c(4, 7, 9, 11, 16, 22),] # MD6812_Right
# x.cluster_and_samples <- x.cluster_and_samples[-c(8, 10, 21, 23, 25, 27),] # MD6812_Left
# x.cluster_and_samples <- x.cluster_and_samples[-c(4:7, 21, 24, 25, 32),] # MD7047
...
draw_nice_tree(tr,show_internal_nodes=T,edge_strength=x.branches.keep.final$Evidence, patientID=substr(patientID, 1, 7))
